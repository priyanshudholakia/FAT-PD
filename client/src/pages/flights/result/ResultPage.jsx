  ...
  useEffect(() => {
    const fetchCalendar = async () => {
      try {
        ...
        // 1. Fetch month(s) covering the active 7 days immediately
        // REDUCED: Removed update-calendar-fare call to reduce API usage
        const primaryReqs = [
        ...
        // 2. DISABLED: Background adjacent months caching to reduce API usage
        // This was causing excessive API calls and rate limiting (429 errors)
        // Users can still navigate to other months which will trigger on-demand loading
        /*
